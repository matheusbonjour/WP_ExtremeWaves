import json
import string
from boia_domain import CreateMapBoia
import numpy as np
...
def roda_boias_wt(boia_sel):
    per = 99
    percentil = per
    boia = boia_sel
    testenome = 'boias_'+ str(boia) + '_extreme_' + str(percentil) 
    ...
    from compara_boias_matheus import compara_boias_daora
